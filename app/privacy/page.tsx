    ...
    <main className="page">
      ...
      <section className="landing-section">
        <p className="hero-note">
          BookAtlas Desktop, the Mac app, is a document reader and light editor. It is built to keep your files
          private.
        </p>
      ...
      <section className="landing-section">
        ...
        <p className="hero-note">
          The policy above covers BookAtlas Desktop. This website, bookatlas.dev, uses Google Analytics to
      ...
      <footer className="landing-footer">
        <Link href="/">bookatlas.dev</Link> · <Link href="/mac">Desktop</Link> · <Link href="/support">Support</Link>
      </footer>
    </main>
  );
}
